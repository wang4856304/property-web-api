...
/**
 * @author wangjun
 * @Title: IdCardNumValidator
 * @ProjectName newHappy
 * @Description: TODO
 * @date 2018/10/18 18:15
 */
public class IdCardNumValidator implements ConstraintValidator<IdCardNumValid, String> {
    @Override
    public void initialize(IdCardNumValid idCardNumValid) {
